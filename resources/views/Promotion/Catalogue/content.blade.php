            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('catalogue.create')}}" class="btn btn-sm btn-primary font-weight-bold mr-2">
                                ...
                                <div class="row align-items-center align-items-sm-start">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-6 mb-4">
                                            <select class="form-control select2-search" id="dt_select_status" name="statuz">
                                                <option value="">-- Filter By Status --</option>
                                                <option value="0">Draft</option>
                                                <option value="1">Publish</option>
                                                <option value="2">Deleted</option>
                                                <option value="3">reDraft</option>
                                                <option value="4">Staff Followup</button>
