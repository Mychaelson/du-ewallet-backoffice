...
@section('content_body')
 ...
 <div class="d-flex flex-column-fluid mt-5">
    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="<?= (isset($detail)) ? route('mission.update',['id' => $detail->id]) : route('mission.save') ?>">
            @csrf
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        @endif
                        <a href="<?= (isset($detail)) ? route('mission.detail',['id' => $detail->id]) : route('mission') ?>" class="btn btn-sm btn-danger font-weight-bold ml-2"><i class="fa fa-arrow-left"></i> Cancel</a>
                    </div>
                </div>
                <div id="card-body">
                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="datetime-pickers form-control" autocomplete="off" id="date_from" name="date_from" value="<?= (isset($detail->start_at)) ? $detail->start_at : "" ?>" placeholder="Select Date" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="datetime-pickers form-control" autocomplete="off" id="date_to" name="date_to" value="<?= (isset($detail)) ? $detail->end_at : "" ?>" placeholder="Select Date" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                            </div>
                                        </div>
                                    </div>
