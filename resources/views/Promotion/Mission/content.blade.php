            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('mission.create')}}" class="btn btn-sm btn-primary font-weight-bold mr-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-6 mb-4">
                                            <select class="form-control select2-search" id="dt_select_status">
                                                ...
                                                <option value="3" >reDraft</option>
                                                <option value="4" >Staff Followup</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(function(){
        ...
        $('#submit-data').click(function(){
            ...
            // e.time=$(".date-range-picker-strict #start").attr('data-selected') + '/' + $(".date-range-picker-strict #end").attr('data-selected'),
