...
<head>
    ...
    <link href="{{ asset('template/css/style.bundle.css?v=').time() }}" rel="stylesheet" type="text/css" />
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="{{ asset('template/css/themes/layout/header/base/dark.css?v=').time() }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('template/css/themes/layout/header/menu/light.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('template/css/themes/layout/brand/dark.css?v=').time() }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('template/css/themes/layout/aside/dark.css?v=').time() }}" rel="stylesheet" type="text/css" />
    @yield('lib_css')
    <!--end::Layout Themes-->
    <link href="{{ asset('css/style.css?v=1.1') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
    class="page-loading-enabled page-loading header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable">
    <!--begin::Page loader-->
                        ...
                        <div class="topbar">
                            <div class="topbar-item">
                                <div class="text-white p-5">
                                    <span class="date-time text-center"
                                        style="width: 200px;display:inline-block;">{{ format_date('', 'F, d M Y H:i:s', 'fulldatetime') }}</span>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column mt-4" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            <span class="text-muted font-weight-bold mr-2">© {{ date('Y') }} {{ config('app.name') }}
                                ~</span>
                            <a href="javascript:;" class="text-dark-75 text-hover-primary">Powered by Keenthemes</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Nav-->
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                ...
                <a href="auth_user/profile/{{ Auth::user()->id }}" class="navi-item">
                    <div class="navi-link">
                        ...
                        <div class="navi-text">
                            ...
                            <div class="text-muted">Account settings and more
                                <span class="label label-light-success label-inline font-weight-bold">updates</span>
                            </div>
                        </div>
                    </div>
                </a>
    ...
    <!-- Alert Modal-->
    <div class="modal fade" id="alertModal" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script src="{{ asset('js/timer.js?v=1.3') }}"></script>
