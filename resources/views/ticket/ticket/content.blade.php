                                ...
                                <div class="row align-items-center align-items-sm-start">
                                    <div class="col-md-8 col-xxl-3 col-lg-12 my-2 my-md-0 mb-0 mb-md-3">
                                        <div class="d-xxl-flex">
                                            <button class="btn btn-light-success mr-2 mr-xxl-6 mb-4 mb-lg-2 mb-xl-4 mb-xxl-0" type="button" id="submit-data"><i class="flaticon2-refresh"></i> Reload
                                                Data</button>
                                    ...
                                    <div class="col-md-4 col-xxl-9 col-lg-12 my-2 my-md-0 mb-0 mb-md-3">
                                        <div class="row">
                                            <div class="col-xxl-3 mb-4 mb-xxl-0">
                                                <select class="form-control select2-search" id="dt_select_category">
                                            ...
                                            <div class="col-xxl-2 mb-4 mb-xxl-0">
                                                <select class="form-control select2-search" id="dt_select_priority">
                                            ...
                                            <div class="col-xxl-2 mb-4 mb-xxl-0">
                                                <select class="form-control select2-search" id="dt_select_scope">
                                            ...
                                            <div class="col-xxl-2 mb-4 mb-xxl-0">
                                                <div class="input-icon flex-grow-1 mr-0 mr-xxl-6 mb-4 mb-lg-2 mb-xl-2 mb-xxl-0">
                                                    <input type="text" class="form-control search-text" placeholder="Search" id="dt_search" autocomplete="off" />
                                                    <span>
        ...
        var dt_load = function() {
            return {
                param: function() {
                    ...
                    e.category = $("#dt_select_category").val().toLowerCase(),
                        e.priority = $("#dt_select_priority").val().toLowerCase(),
                        e.status = $("#dt_select_status").val().toLowerCase(),
                        e.scope = $("#dt_select_scope").val().toLowerCase(),
                        e.search = $("#dt_search").val().toLowerCase(),
                        e.pagination = {
                ...
                init: function($params) {
                    ...
                    $.post("{{ route('ticket-list.dt') }}", $data, function(e) {
