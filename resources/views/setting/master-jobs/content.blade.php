        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('create-master-jobs') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Name Pekerjaan</label>
                            <input type="text" required name="nama_pekerjaan" class="form-control" placeholder="Nama Pekerjaan">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Jobs Name</label>
                            <input type="text" required name="jobs_name" class="form-control" placeholder="Jobs Name">
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('edit-process-master-jobs') }}" method="POST" >
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Type</label>
                            <select class="form-control" required id="edit-type" name="type">
                                <option value="Low">Low</option>
                                <option value="Medium">Medium</option>
                                <option value="Hight">Hight</option>
                            </select>
        ...
        var dt_load = function() {
            return {
                ...
                init: function($params) {
                    ...
                    $.post("{{ route('master-jobs.dt') }}", $data, function(e) {
