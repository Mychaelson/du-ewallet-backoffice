    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Wallet Return Adjustment</h5>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-9">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Wallet Return Adjustment</h5>
                                <form>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">List Request Wallet Return Adjustment</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Return Adjustment History</h5>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        <thead class="thead-light">
                                            <tr>
