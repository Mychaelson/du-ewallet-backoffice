        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    ...
                    <a class="btn btn-light-primary mr-2 mr-xxl-6 mb-4 mb-lg-2 mb-xl-6 mt-xl-6" type="button" id="add-data"  href="{{route('wallet.label.add') }}"><i class="flaticon2-plus"></i> Add Data</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
...
var dt_load = function() {
    return {
        ...
        init: function($params) {
            ...
            $.post("{{ route('wallet-label.dt') }}",$data,function(e){
