...
@section('content_body')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form class="form" method="post" action="{{ route('blacklist.save') }}" autocomplete="off">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xxl-4 col-md-6">
                                            <input class="form-control @error('country_of_origin') is-invalid @enderror" type="text" name="country_of_origin" value="{{ old('country_of_origin') ?: '' }}">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xxl-4 col-md-6">
                                            <input class="form-control @error('place_of_birth') is-invalid @enderror" type="text" name="place_of_birth" value="{{ old('place_of_birth') ?: '' }}">
