                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <select id="filterstatus" class="form-control">
                                    ...
                                    <option value="4">Request to Approve</option>
                                </select>
                            </div>                            
                            <hr>
                            <div class="form-group">
                                <label for="filterRegister">Filter By Date Request :</label>
    ...
    var dt_load = function () {
        return {
            ...
            init: function ($params) {
                ...
                $.post("{{ route('user-kyc.dt') }}", $data, function (e) {
