                                ...
                                <div class="row align-items-center align-items-sm-start">
                                    ...
                                    <div class="col">
                                        <div class="float-right">
                                            <a href="{{route('create-product-category')}}"
                                                class="btn btn-light-primary mr-2 mr-xxl-6 mb-4 mb-lg-2 mb-xl-4 mb-xxl-0"><i class="flaticon2-plus"></i>Create</a>
        ...
        var dt_load = function() {
            return {
                ...
                init: function($params) {
                    ...
                    $.post("{{ route('product-category.dt') }}", $data, function(e) {
