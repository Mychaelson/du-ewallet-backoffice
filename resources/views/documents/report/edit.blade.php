        ...
        <div class="card m-4">
            ...
            <div class="card-body">
                ...
                <div class="form-floating p-5" style="height: 950px">
                    ...
                    <input type="text" value="{{ $data->subject }}" name="subject" class="w-100"
                       required style="height: 40px; text-align: center;border: none; outline: 0; font-size:26px;"
                        placeholder="REPORT SUBJECT">
                    <input type="text" value="{{ $data->number }}" name="number" class="w-100 mb-4"
                       required style="height: 40px; text-align: center;border: none; outline: 0; font-size:26px;"
                        placeholder="REPORT NUMBER">
                    <input type="hidden" name="content" value="{{ $data->contents }}" id="get-content">
                    </form>
                    ...
                    <div style="position: absolute; top:80%; width:93%">
                        ...
                        <a href="{{$data->attachements}}" style="color: gray" id="file-upload-filename">See File</a>
                    </div>
                </div>
            </div>
