                                ...
                                <div class="row align-items-center align-items-sm-start">
                                    ...
                                    <div class="col">
                                        <div class="float-right">
                                            ...
                                            type="button"><i class="flaticon2-plus"></i>
                                            Create</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-2 mb-4 mb-xxl-0">
                                                <div class="input-icon flex-grow-1 mr-0 mr-xxl-6 mb-4 mb-lg-2 mb-xl-2 mb-xxl-0">
                                                    <input type="text" class="form-control search-text" placeholder="Search by Name" id="dt_search_name" autocomplete="off" />
                                                    <span>
...
var dt_load = function() {
    return {
        param: function() {
            ...
            // e.locale=$("#dt_select_locale").val().toLowerCase(),
            // e.searchNickname=$("#dt_search_name").val().toLowerCase(),
        ...
        init: function($params) {
            ...
            $.post("{{ route('doc.dt') }}",$data,function(e){
